    ...
    public partial class SistemaUsuarios : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CATEGORI__A3C02A1065B3DDAD", x => x.IdCategoria);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdProducto = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CodigoBarra = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    Descripcion = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PRODUCTO__098892109A4BD9E6", x => x.IdProducto);
                    table.ForeignKey(
                        name: "FK_IDCATEGORIA",
